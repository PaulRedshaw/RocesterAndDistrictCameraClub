    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Radcc.Data.Context.ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            context.Programmes.AddOrUpdate(e => e.Id,
               ...
               new Programme { Id = 30, Title = "Competition", EventDate = new DateTime(2017, 2, 21, 20, 00, 0), Description = "Subject-Theme: Open Competiton and must have been taken in 2016", Comment = "Judge: Peter Cheetham" },
               ...
               new Programme { Id = 32, Title = "Irene Froy DVD Presentation", EventDate = new DateTime(2017, 3, 21, 20, 00, 0), Description = "A Paaaion for Pastels", Comment = "" },
